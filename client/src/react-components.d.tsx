...
export type Query = {
  __typename?: "Query";
  feProblems?: Maybe<Array<Problem>>;
  feSimilars?: Maybe<Array<Problem>>;
};

export type FeProblemsQueryVariables = Exact<{ [key: string]: never }>;

export type FeProblemsQuery = { __typename?: "Query" } & {
  feProblems?: Maybe<
    Array<
...
export type FeSimilarsQuery = { __typename?: "Query" } & {
  feSimilars?: Maybe<
    Array<
      { __typename?: "Problem" } & Pick<
        Problem,
...
`;
export type FeProblemsComponentProps = Omit<
...
export const FeProblemsComponent = (props: FeProblemsComponentProps) => (
  <ApolloReactComponents.Query<FeProblemsQuery, FeProblemsQueryVariables>
    query={FeProblemsDocument}
    {...props}
  />
);

export type FeProblemsProps<
  TChildProps = {},
...
> = {
  ...
  TChildProps;
export function withFeProblems<
  TProps,
  TChildProps = {},
  TDataName extends string = "data"
>(
 ...
 * });
 */
export function useFeProblemsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    FeProblemsQuery,
    FeProblemsQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<FeProblemsQuery, FeProblemsQueryVariables>(
    FeProblemsDocument,
    baseOptions
  );
}
export function useFeProblemsLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<
    FeProblemsQuery,
    FeProblemsQueryVariables
  >(FeProblemsDocument, baseOptions);
}
export type FeProblemsQueryHookResult = ReturnType<typeof useFeProblemsQuery>;
export type FeProblemsLazyQueryHookResult = ReturnType<
  typeof useFeProblemsLazyQuery
>;
export type FeProblemsQueryResult = ApolloReactCommon.QueryResult<
  FeProblemsQuery,
  FeProblemsQueryVariables
>;
...
`;
export type FeSimilarsComponentProps = Omit<
  ApolloReactComponents.QueryComponentOptions<
    FeSimilarsQuery,
...
export const FeSimilarsComponent = (props: FeSimilarsComponentProps) => (
  <ApolloReactComponents.Query<FeSimilarsQuery, FeSimilarsQueryVariables>
    query={FeSimilarsDocument}
    {...props}
  />
);

export type FeSimilarsProps<
  TChildProps = {},
  TDataName extends string = "data"
> = {
  [key in TDataName]: ApolloReactHoc.DataValue<
  ...
  TChildProps;
export function withFeSimilars<
  TProps,
  TChildProps = {},
  TDataName extends string = "data"
>(
 ...
 * });
 */
export function useFeSimilarsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    FeSimilarsQuery,
    FeSimilarsQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<FeSimilarsQuery, FeSimilarsQueryVariables>(
    FeSimilarsDocument,
    baseOptions
  );
}
export function useFeSimilarsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    FeSimilarsQuery,
    FeSimilarsQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    FeSimilarsQuery,
    FeSimilarsQueryVariables
  >(FeSimilarsDocument, baseOptions);
}
export type FeSimilarsQueryHookResult = ReturnType<typeof useFeSimilarsQuery>;
export type FeSimilarsLazyQueryHookResult = ReturnType<
  typeof useFeSimilarsLazyQuery
>;
export type FeSimilarsQueryResult = ApolloReactCommon.QueryResult<
  FeSimilarsQuery,
  FeSimilarsQueryVariables
>;
